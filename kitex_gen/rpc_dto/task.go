...
type Task struct {
	...
	NextTime   string `thrift:"NextTime,7" json:"NextTime"`
	LastStatus int16  `thrift:"LastStatus,8" json:"LastStatus"`
}
...
func (p *Task) GetId() int64 {
	return p.Id
}

func (p *Task) GetCode() string {
	return p.Code
}
...
func (p *Task) GetRuleId() int64 {
	return p.RuleId
}

func (p *Task) GetFrequency() int64 {
	return p.Frequency
}

func (p *Task) GetEnable() bool {
	return p.Enable
}

func (p *Task) GetNextTime() string {
	return p.NextTime
}

func (p *Task) GetLastStatus() int16 {
	return p.LastStatus
}
...
func (p *Task) SetNextTime(val string) {
	p.NextTime = val
}
func (p *Task) SetLastStatus(val int16) {
	p.LastStatus = val
}
...
func (p *Task) writeField7(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("NextTime", thrift.STRING, 7); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Task) writeField8(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("LastStatus", thrift.I16, 8); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI16(p.LastStatus); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *Task) DeepEqual(ano *Task) bool {
	...
	if !p.Field7DeepEqual(ano.NextTime) {
		return false
	}
...
func (p *Task) Field8DeepEqual(src int16) bool {
...
func (p *TaskResponse) GetTask() *Task {
	if !p.IsSetTask() {
...
func (p *TasksResponse) GetTasks() []*Task {
	return p.Tasks
}
