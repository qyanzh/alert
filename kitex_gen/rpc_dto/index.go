...
func (p *Index) GetId() int64 {
	return p.Id
}

func (p *Index) GetCode() string {
	return p.Code
}

func (p *Index) GetName() string {
	return p.Name
}

func (p *Index) GetType() bool {
	return p.Type
}

func (p *Index) GetExpr() string {
	return p.Expr
}

func (p *Index) GetTimeRange() int64 {
	return p.TimeRange
}
...
func (p *Index) SetTimeRange(val int64) {
	p.TimeRange = val
}
...
func (p *Index) Field6DeepEqual(src int64) bool {
...
func (p *IndexResponse) GetIndex() *Index {
	if !p.IsSetIndex() {
...
func (p *IndexsResponse) GetIndexs() []*Index {
	return p.Indexs
}
...
type MapIndexResponse struct {
	Indexs map[string]float64 `thrift:"indexs,1" json:"indexs"`
}
...
func (p *MapIndexResponse) GetIndexs() map[string]float64 {
	return p.Indexs
}
func (p *MapIndexResponse) SetIndexs(val map[string]float64) {
	p.Indexs = val
}
...
func (p *MapIndexResponse) writeField1(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteMapBegin(thrift.STRING, thrift.DOUBLE, len(p.Indexs)); err != nil {
		return err
	}
...
func (p *MapIndexResponse) Field1DeepEqual(src map[string]float64) bool {
