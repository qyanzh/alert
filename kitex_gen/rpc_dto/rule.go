...
func (p *Rule) GetId() int64 {
	return p.Id
}

func (p *Rule) GetCode() string {
	return p.Code
}

func (p *Rule) GetRoomId() int64 {
	return p.RoomId
}

func (p *Rule) GetName() string {
	return p.Name
}

func (p *Rule) GetType() bool {
	return p.Type
}

func (p *Rule) GetExpr() string {
	return p.Expr
}
...
func (p *RuleResponse) GetRule() *Rule {
	if !p.IsSetRule() {
...
func (p *RulesResponse) GetRules() []*Rule {
	return p.Rules
}
...
func (p *CheckResponse) GetResult_() bool {
	return p.Result_
}
