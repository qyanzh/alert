...
func (p *kAlertServiceClient) AddAlert(ctx context.Context, ruleCode string, time string, roomId int64, callOptions ...callopt.Option) (r *rpc_dto.ErrResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AddAlert(ctx, ruleCode, time, roomId)
}

func (p *kAlertServiceClient) SelectAlert(ctx context.Context, roomId int64, ruleCode string, startTime string, endTime string, callOptions ...callopt.Option) (r *rpc_dto.AlertsResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
