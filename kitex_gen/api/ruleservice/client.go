...
func (p *kRuleServiceClient) DeleteRule(ctx context.Context, code string, callOptions ...callopt.Option) (r *rpc_dto.ErrResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteRule(ctx, code)
}

func (p *kRuleServiceClient) UpdateRule(ctx context.Context, rule *rpc_dto.Rule, callOptions ...callopt.Option) (r *rpc_dto.ErrResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
